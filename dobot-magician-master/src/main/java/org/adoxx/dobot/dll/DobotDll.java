...
public interface DobotDll extends Library {
  DobotDll instance = (DobotDll) Native.loadLibrary("libDobotDll.dylib", DobotDll.class);
  ...
  public enum JOG {
    JogIdle, JogAPPressed, JogANPressed, JogBPPressed, JogBNPressed, JogCPPressed, JogCNPressed, JogDPPressed, JogDNPressed, JogEPPressed, JogENPressed
  };
  ...
  public enum PTPMode {
    PTPJUMPXYZMode, PTPMOVJXYZMode, PTPMOVLXYZMode,

    PTPJUMPANGLEMode, PTPMOVJANGLEMode, PTPMOVLANGLEMode,

    PTPMOVJXYZINCMode, PTPMOVLXYZINCMode
  };
  ...
  public enum DobotResult {
    DobotConnect_NoError, DobotConnect_NotFound, DobotConnect_Occupied
  };
  ...
  int SetEndEffectorParams(EndEffectorParams endEffectorParams, boolean isQueued,
      IntByReference queuedCmdIndex);
  ...
  int SetJOGJointParams(JOGJointParams jogJointParams, boolean isQueued,
      IntByReference ueuedCmdIndex);

  int SetJOGCoordinateParams(JOGCoordinateParams jogCoordinateParams, boolean isQueued,
      IntByReference ueuedCmdIndex);

  int SetJOGCommonParams(JOGCommonParams jogCommonParams, boolean isQueued,
      IntByReference ueuedCmdIndex);

  // Playback functions
  int SetPTPCmd(PTPCmd ptpCmd, boolean isQueued, IntByReference queuedCmdIndex);

  int SetPTPJointParams(PTPJointParams ptpJointParams, boolean isQueued,
      IntByReference ueuedCmdIndex);

  int SetPTPCoordinateParams(PTPCoordinateParams ptpCoordinateParams, boolean isQueued,
      IntByReference ueuedCmdIndex);
